...
```mermaid
graph TD
    A[量子信息理论] --> B[应用层面<br>核心协议与算法]
    A --> C[基础理论层面<br>数学与物理基础]
    ...
    B1 --> B1a[量子密钥分发<br>量子隐形传态<br>密集编码]
    B2 --> B2a[量子算法<br>量子模拟<br>量子机器学习]
    B3 --> B3a[量子密码协议<br>后量子密码]
    B4 --> B4a[高精度测量<br>量子传感]
    ...
    C1 --> C1a[量子熵<br>信道容量<br>量子资源理论]
    C2 --> C2a[纠缠度量<br>纠缠蒸馏<br>纠缠判据]
    C3 --> C3a[量子纠错码<br>容错量子计算]
    C4 --> C4a[贝尔非定域性<br>量子基础]
```
